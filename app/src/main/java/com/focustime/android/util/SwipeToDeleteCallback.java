...
import com.focustime.android.ui.calendar.month.DailyMonthAdapater;
...
public class SwipeToDeleteCallback extends ItemTouchHelper.SimpleCallback {
    ...
    private final ColorDrawable background;
        ...
        public SwipeToDeleteCallback(DailyMonthAdapater adapter) {
            ...
            background = new ColorDrawable(adapter.getContext().getResources().getColor(R.color.colorDelete, null));
        }
